-- =====================================================================
-- Calendário deixa de contar lançamentos CONTABIL como despesa
-- =====================================================================
--
-- PROBLEMA
--   Transferências entre contas próprias (ex.: Stone -> BS Cash em
--   02/06: R$ 17.000 + R$ 10.000) apareciam como despesa no calendário,
--   e a saída real do dinheiro (folha via BS Cash em 03/06) contava de
--   novo: dupla contagem. Causa: a categoria "Transferencia entre
--   Contas" mapeia para o dre_grupo CONTABIL, e o entra_dre da view
--   fato_financeiro só exclui TRANSFERENCIA (nome usado no histórico)
--   — a exclusão nunca alcançou os dados vivos. O painel de Despesas
--   (mv_despesa_mensal) já exclui CONTABIL explicitamente e o DRE tem
--   linha própria para o grupo; só o calendário usava apenas entra_dre.
--
-- SOLUCAO
--   listar_calendario_financeiro (CTE despesas_reais) e
--   listar_despesas_dia passam a excluir dre_grupo CONTABIL, mesma
--   regra de mv_despesa_mensal (ajuste contábil não é vazamento de
--   caixa real: estornos, devoluções, antecipações e transferências).
--   Nenhuma outra parte das funções muda.
-- =====================================================================
